...
"角色卡"是 SillyTavern 的打包格式名称，不是"一张卡 = 一个角色"的意思。一个角色卡项目可以包含多个角色、NPC、世界观等完整内容，最终打包为一个角色卡文件。本文档中"角色卡"均指打包格式，不暗示角色数量。
...
4. **创建条目**：按创作规划依次编写（禁词扫描 + DoubleCheck）→ `references/composition.md`
